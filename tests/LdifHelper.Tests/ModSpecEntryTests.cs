// -----------------------------------------------------------------------
//  <copyright file="EncodingTests.cs" company="Active Netwerx">
...
namespace LdifHelper.Tests
{
    ...
    public class ModSpecEntryTests
    {
        ...
        {
            // Arrange.
            int modSpec = Enum.GetValues(typeof(ModSpecType)).Cast<int>().Max() + 1;
        ...
        public void CtorParameterValuesEmptyWhenModSpecIsAddThrows() =>
            Assert.Throws<ArgumentOutOfRangeException>(() => new ModSpec(ModSpecType.Add, "description", new object[0]));
