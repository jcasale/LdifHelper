...
namespace LdifHelper.Tests
{
    ...
    {
        private static readonly string DistinguishedName = "CN=Sophie Germain,OU=users,DC=company,DC=com";
        ...
        private static readonly string NewRdn = "CN=Emmy Noether";

        private static readonly string NewSuperior = "OU=admins,DC=company,DC=com";

        private static readonly string Rdn = "CN=Sophie Germain";
        ...
        {
            // Act.
            ChangeModDn sut = new ChangeModDn(DistinguishedName, NewRdn, false, null);
        ...
        {
            // Act.
            ChangeModDn sut = new ChangeModDn(DistinguishedName, NewRdn, true, NewSuperior);
        ...
        {
            // Act.
            ChangeModDn sut = new ChangeModDn(DistinguishedName, null, true, NewSuperior);
